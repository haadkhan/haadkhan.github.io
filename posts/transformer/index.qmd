...
$$
The weights $\alpha_ij$ selects the data to pull up. The weights are defined by calculating the relation between key and query $q_i^Tk_j$ and calculating the softmax over the sequence.
$$
...
1). Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz Kaiser, Illia Polosukhin: “Attention Is All You Need”, 2017; <a href='http://arxiv.org/abs/1706.03762'>arXiv:1706.03762</a>
2). [Stanford CS224N NLP](http://web.stanford.edu/class/cs224n/index.html)</p>
3). [Stanford CS224N NLP | Self-Attention and Transformers](http://web.stanford.edu/class/cs224n/readings/cs224n-self-attention-transformers-2023_draft.pdf)</p>
