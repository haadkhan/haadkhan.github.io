...
<p>No. of param = V x D = 50257 * 768 = 38 597 376</p>
...
<p>No. of param = C x D = 1024 * 768 = 786 432</p>
...
<p>No. of param = 2xD = 2 x 768 = 1536</p>
...
<p>No. of param = [DxDxD] = 590592</p>
<p>params = c_attn + c_proj = [Dx(3xD)+(3xD)] + [DxDxD] = 2362368</p>
...
<p>c_fc = [Dx(4xD)+(4xD)] = 2362368</p>
<p>c_proj = [(4xD)xD+D] = 2360064</p>
<p>No. of param = [Dx(4xD)+(4xD)] + [(4xD)xD+D] = 4722432</p>
```{python eval=false}
...
<p>No. of param = wte + cte + Lx(ln_1 + attn + ln_2 + mlp) + ln_f</p>
<p>             = 38597376 + 786432 + 12x(1536 + 2362368 + 1536 + 4722432) + 1536</p>
<p>             = 124 439 808</p>
