...
In a recent hackathon, the VCPI prediction contest, I worked on predicting gene expression directly from chemical structures. The goal was to take a compound's SMILES string (a text-based representation of its chemical structure) and predict its effect on the expression of 12,995 different genes.
